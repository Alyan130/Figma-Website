...
import pic3 from "@/app/public/halfpod.png";
        ...
        <>
            <section className="w-screen max-w-screen-2xl 2xl:mx-auto hidden md:block">
                <div className="w-full flex flex-row">
                    <div className="w-[50%]">
                        <div className="flex flex-row items-center justify-evenly">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-[15px] leading-[26px] font-medium text-para">
                        ...
                        <div className="w-[100%] flex flex-row">
                            <div className="w-[50%] bg-back1 flex flex-row items-center justify-between space-x-12">
                                ...
                                <div>
                                    <h2 className="pr-4 md:text-[29px] mb-1">Apple AirPods <span className="font-font2">Max</span></h2>
                            ...
                            <div className="w-[50%] bg-back flex flex-row items-center justify-center space-x-10">
                                <div className="md:w-[200px] md:mt-10 md:h-[190px]">
                                    <Image src={pic3} alt="" className="w-full h-full"/>
                                </div>
                                <div className="pr-4">
                    ...
                    <div className="w-[50%] bg-back1 flex items-center flex-row justify-between gap-10">
                        <div className="pl-9">
                            <h1 className="text-[64px] text-black font-hfont">Macbook <span className="font-semibold font-sans">Air</span></h1>
                            <p className="text-[15px] leading-[25px] text-para mb-4">
                                The new 15‑inch MacBook Air makes room for more of what you love with a spacious Liquid Retina display.
                            </p>
                            <button className="md:w-[183px] w-[191px] p-3 md:p-3 bg-transparent text-black border-[1px] border-black md:text-[14px] rounded-[6px]">
                                Shop now
                            </button>
                        </div>
                        <div data-aos="zoom-out-left" className="w-[659px] h-[479px]">
            ...
            <section className="md:hidden w-screen max-w-screen-2xl 2xl:mx-auto">
                <div className="w-full">
                    <div className="w-full flex items-center justify-center bg-back1 flex-col p-5 px-2"> 
                        <div data-aos="fade-left" className="w-[200px] h-[200px] mb-7">
                    ...
                    <div className="w-full flex items-center justify-center flex-col p-6 bg-back"> 
                        <div data-aos="fade-right" className="w-[192px] h-[200px]">
                            <Image src={image2} alt="" className="w-[270px] h-[160px]"/>
                        </div>
                        <div className="text-center -mt-8 mb-4">
                            <h2 className="text-[34px] text-slate-100">Apple Vision<span className="font-bold text-slate-100"> Pro</span></h2>
                            <p className="text-[15px] leading-[25px] text-para">An immersive way to experience entertainment</p>
                        </div>
                    </div>
                    <div className="w-full flex items-center justify-center flex-col p-4"> 
                        <div data-aos="fade-left" className="w-[192px] h-[200px]">
                            <Image src={image3} alt="" className="w-[300px] h-[210px]"/>
                        </div>
                        <div className="text-center mt-4 mb-4">
                            <h2 className="text-[34px] text-black">Playstation <span className="font-bold">5</span></h2>
                            <p className="text-[15px] leading-[25px] text-para">Incredibly powerful CPUs, GPUs, and an SSD with integrated I/O will redefine your PlayStation experience.</p>
                        </div>
                    </div>
                    <div className="w-full flex items-center justify-center flex-col p-4 bg-back1"> 
                        <div data-aos="fade-right" className="w-[250px] h-[220px]">
                            <Image src={image4} alt="" className="w-[250pc] h-full"/>
                        </div>
                        <div className="text-center -mt-8 mb-5">
                            <h2 className="text-[34px] text-black"><span className="font-bold">Macbook</span> Air</h2>
                            <p className="text-[15px] leading-[25px] text-para">Computational audio. Listen, it&apos;s powerful</p>
                        </div>
                    </div>
                </div>
