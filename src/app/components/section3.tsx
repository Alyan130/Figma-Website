...
export default function Section3(){
    return(
    <>
    <section className="mt-12 md:mt-20 w-screen max-w-screen-2xl xl:mx-auto">
    <div className="w-full relative">
        <div className="absolute inset-0 flex flex-col items-center justify-center ">
            <h1 className="text-[48px] mb-0 text-white font-extralight sm:text-[52px] md:text-[72px] sm:ml-14 ">Big Summer <span className="sm-text-[48px] md:text-[72px] font-bold sm:inline hidden">Sale</span></h1>
