...
export default function Hero(){
    ...
    <section className="w-screen max-w-screen-2xl xl:mx-auto">
        ...
        <div className="md:text-start text-center mt-24 mb-16">
             ...
             <h1 className="md:text-[96px] mb-5 text-white text-[72px] leading-[76px]">IPhone 14 <span className="font-bold">Pro</span></h1>
        ...
        <div className=" md:h-[632px] w-[258px] md:w-[320px] md:mt-[1px]  h-[320px] -mt-24"> 
